        ...
        if summary['step'] % cfg.log_every == 0:
            ...
            logging.info(
                ...
                .format(time.strftime("%Y-%m-%d %H:%M:%S"),
                        ...
                        acc_str, time_spent))
            print('{}, Train, Epoch : {}, Step : {}, Loss : {}, Acc : {}, Run Time : {:.2f} sec'
                  .format(time.strftime("%Y-%m-%d %H:%M:%S"),
                          summary['epoch'] + 1, summary['step'], loss_str,
                          acc_str, time_spent))
        ...
        if summary['step'] % cfg.test_every == 0:
            ...
            logging.info(
                ...
                'Mean auc: {:.3f} ''Run Time : {:.2f} sec'.format(
                    ...
                    time_spent))
            print('{}, Dev, Step : {}, Loss : {}, Acc : {}, Auc : {}, Mean auc: {:.3f} ''Run Time : {:.2f} sec'.format(
                time.strftime("%Y-%m-%d %H:%M:%S"),
                summary['step'],
                loss_dev_str,
                acc_dev_str,
            ...
            if save_best:
                ...
                print('{}, Best, Step : {}, Loss : {}, Acc : {},Auc :{},Best Auc : {:.3f}'.format(
                    time.strftime("%Y-%m-%d %H:%M:%S"),
                    summary['step'],
                    loss_dev_str,
                    acc_dev_str,
